...
---
*Last updated: 2026-04-08 after v1.2 milestone complete*Pokémon Roulette is a browser-based randomizer game where players spin a roulette wheel to assemble a Pokémon team and battle through a generation's gym leaders, Elite Four, and Champion. The Pokédex feature (v1.0+) adds a persistent global tracker that records every Pokémon assigned to the player's team across all runs, with a special distinction for Pokémon that were on the team when the Champion was defeated. The "{Region} Dex" view (v1.1+) shows every Pokémon in the generation including legendaries and mythicals.
...
- [ ] Fix Pokédex modal fullscreen on mobile (MOB-01)
- [ ] Pokémon detail modal — official-artwork circle, number, name (DETAIL-01)
- [ ] Detail modal — alternate forms (DETAIL-02)
- [ ] Persist shiny flag in PokedexData (SHINY-01)
- [ ] Shiny toggle button in detail modal (SHINY-02)
- [ ] CSS glow-pulse animation for won Pokémon cells (VIS-01)
