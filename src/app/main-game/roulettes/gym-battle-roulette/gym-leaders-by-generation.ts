...
export const gymLeadersByGeneration: Record<number, GymLeader[]> = {
    ...
    3: [
        ...
        {   name: 'Liza & Tate',
            sprite: "https://archives.bulbagarden.net/media/upload/3/38/Spr_RS_Tate_and_Liza.png",
            quotes: [
    ...
    5: [
        {
            ...
            sprite: [
                'https://archives.bulbagarden.net/media/upload/4/4b/Spr_B2W2_Cilan.png',
                'https://archives.bulbagarden.net/media/upload/f/f0/Spr_B2W2_Chili.png',
                'https://archives.bulbagarden.net/media/upload/c/cc/Spr_B2W2_Cress.png'
            ],
            quotes: [
        ...
        {
            name: 'Burgh',
            sprite: "https://archives.bulbagarden.net/media/upload/3/35/Spr_B2W2_Burgh.png",
            quotes: [
        ...
        {
            name: 'Elesa',
            sprite: "https://archives.bulbagarden.net/media/upload/9/97/Spr_B2W2_Elesa.png",
            quotes: [
        ...
        {
            name: 'Clay',
            sprite: "https://archives.bulbagarden.net/media/upload/b/bb/Spr_B2W2_Clay.png",
            quotes: [
        ...
        {
            name: 'Skyla',
            sprite: "https://archives.bulbagarden.net/media/upload/5/5a/Spr_B2W2_Skyla.png",
            quotes: [
        ...
        {
            name: 'Brycen',
            sprite: "https://archives.bulbagarden.net/media/upload/2/28/Spr_B2W2_Brycen.png",
            quotes: [
        ...
        },
        {
            name: 'Drayden/Iris',
            sprite: [
                "https://archives.bulbagarden.net/media/upload/b/b6/Spr_B2W2_Drayden.png",
    ...
    6: [
        ...
        {
            name: 'Olympia',
            sprite: "https://archives.bulbagarden.net/media/upload/7/7f/VSOlympia.png",
            quotes: [
    ...
    7: [
        {
            name: 'Ilima',
            sprite: "https://archives.bulbagarden.net/media/upload/b/bf/VSIlima_USUM.png",
            quotes: [
        ...
        {
            name: 'Hala',
            sprite: "https://archives.bulbagarden.net/media/upload/6/6b/VSHala_2_USUM.png",
            quotes: [
                "Ho!",
                "I have been expecting you. I am Hala, the kahuna of Melemele Island.",
                "Old Hala here will be going all out! Let the grand trial begin!"
            ]
        },
        {
            name: 'Lana',
        ...
        {
            name: 'Sophocles',
            sprite: "https://archives.bulbagarden.net/media/upload/a/aa/VSSophocles.png",
            quotes: [
                "Mm-hmm. I've gotta show Big Mo how strong I can be...",
                "And I did say that we should battle next time, right?"
            ]
        },
        {
            name: 'Acerola',
            sprite: "https://archives.bulbagarden.net/media/upload/6/6c/VSAcerola.png",
            quotes: [
                "You made it through Sophocles's trial, huh?",
                "That's really great! ",
        ...
        {
            name: 'Nanu',
            sprite: "https://archives.bulbagarden.net/media/upload/5/57/VSNanu_2.png",
            quotes: [
                "You there.",
    ...
    8: [
        ...
        },
        {
            name: 'Bea/Allister',
            sprite: [
                "https://archives.bulbagarden.net/media/upload/5/57/VSBea.png",
                "https://archives.bulbagarden.net/media/upload/2/27/VSAllister.png"
            ],
            quotes: [
